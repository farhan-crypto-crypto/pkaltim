...
<head>
    ...
    <title>Kelola Fasilitas - Kaltim Nature</title>
        ...
        <aside class="w-64 bg-sidebar text-white flex flex-col justify-between hidden md:flex shadow-xl z-20">
            <div>
                ...
                <nav class="mt-8 px-4 space-y-2">
                        ...
                        <a href="{{ route('admin.facility.index') }}" class="flex items-center gap-3 px-4 py-3 bg-active rounded-lg text-white shadow-lg shadow-green-900/50 transition-all">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center mx-auto text-gray-600">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <form action="{{ route('admin.facility.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus fasilitas {{ $item->name }}?');">
                                                @csrf @method('DELETE')
        ...
        <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl">
            ...
            <form action="{{ route('admin.facility.store') }}" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" placeholder="Contoh: WiFi Gratis" required class="w-full rounded-lg border-gray-300 border p-2.5 focus:border-green-500 focus:ring-green-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                        Icon Class (FontAwesome) 
                        <a href="https://fontawesome.com/search?o=r&m=free" target="_blank" class="text-green-600 hover:underline text-xs ml-1">(Cari Icon Disini)</a>
                    </label>
                    <input type="text" name="icon_class" placeholder="Contoh: fa-solid fa-wifi" required class="w-full rounded-lg border-gray-300 border p-2.5 focus:border-green-500">
                    <p class="text-xs text-gray-400 mt-1">Gunakan class lengkap, misal: <span class="font-mono text-gray-600">fa-solid fa-parking</span></p>
                </div>
    ...
    <div id="editModal" class="fixed inset-0 z-50 hidden overflow-y-auto bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl">
            ...
            <form id="editForm" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Fasilitas</label>
                    <input type="text" id="edit_name" name="name" required class="w-full rounded-lg border-gray-300 border p-2.5 focus:border-green-500 focus:ring-green-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">
                        Icon Class (FontAwesome)
                    </label>
                    <input type="text" id="edit_icon_class" name="icon_class" required class="w-full rounded-lg border-gray-300 border p-2.5 focus:border-green-500">
                </div>
