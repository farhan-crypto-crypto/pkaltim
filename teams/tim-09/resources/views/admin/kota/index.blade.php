...
<head>
    ...
    <title>Data Kota | Admin Kulkaltim</title>
...
<body>
    ...
    {{-- SIDEBAR NAVIGATION --}}
    <nav class="sidebar">
        <div class="sidebar-brand fw-bold"><a class="navbar-brand fw-bold d-flex align-items-center gap-2" href="#">
                <img
        ...
        <div class="sidebar-menu">
            ...
            <a href="#" class="nav-link active"><i class="bi bi-map-fill"></i> Data Kota</a>
    ...
    <main class="main-content">
        ...
        <div class="d-flex align-items-center d-lg-none mb-4">
            ...
            <h5 class="m-0 fw-bold">Data Kota</h5>
        </div>

        <div class="mb-4">
            <h3 class="fw-bold text-dark mb-1 d-none d-lg-block">Manajemen Kota</h3>
            <p class="text-muted small">Kelola data wilayah kota kuliner di Kalimantan Timur.</p>
        </div>
        ...
        <div class="card-modern">
            <div class="card-header bg-white p-4 border-bottom d-flex justify-content-between align-items-center">
                <h5 class="fw-bold mb-0">Daftar Kota</h5>
                    ...
                    <table class="table table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fw-medium py-3">{{ $kota->nama_kota }}</td>
                                <td class="text-center py-3">
                                    <div class="d-flex justify-content-center gap-2">
                                        <button type="button" 
                                                class="btn btn-sm btn-outline-warning" 
                                                data-bs-toggle="modal" 
                                                data-bs-target="#modalEdit-{{ $kota->id_kota }}">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        
                                        <form onsubmit="return confirm('Yakin hapus?')" 
                                              action="{{ route('admin.kota.destroy', $kota->id_kota) }}" 
                                              method="POST" 
                                              class="d-inline">
                                            @csrf
                                            @method('DELETE')
                            ...
                            {{-- MODAL EDIT KOTA --}}
                            <div class="modal fade" id="modalEdit-{{ $kota->id_kota }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content border-0 shadow-lg rounded-4">
                                        <div class="modal-header border-bottom-0 pb-0">
                                            <h5 class="modal-title fw-bold">Edit Kota</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        
                                        <form action="{{ route('admin.kota.update', $kota->id_kota) }}" method="POST">
                                            @csrf
                                            @method('PUT') 
                                            <div class="modal-body pt-4">
                                                <div class="mb-3">
                                                    <label class="form-label fw-medium text-muted small text-uppercase">Nama Kota</label>
                                                    <input type="text" 
                            ...
                            <tr>
                                <td colspan="3" class="text-center py-5 text-muted">
                                    <i class="bi bi-map display-4 mb-3 d-block opacity-25"></i>
                                    Belum ada data kota.
                                </td>
                            </tr>
                            @endforelse
